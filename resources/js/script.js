$(document).ready(function () {
  ...
  $('a[href*="#"]')
    ...
    $(".js--wp-1").waypoint(function(direction) {
      $(".js--wp-1").addClass("animated__animate");
    ...
    $(".js--wp-2").waypoint(function(direction) {
      $(".js--wp-2").addClass("animated__animate");
    ...
    $(".js--wp-3").waypoint(function(direction) {
      $(".js--wp-3").addClass("animated__animate");
    ...
    $(".js--wp-4").waypoint(function(direction) {
      $(".js--wp-4").addClass("animated__animate");
    ...
    $(".js--nav-icon").click(function() {
      ...
      // The slideToggle method just opens and closes a box. 200 ms
      nav.slideToggle(200);
